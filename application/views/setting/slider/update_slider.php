                        ...
                        <div class="container-fluid mt-3">
                            ...
                            <div class="card">
                                    ...
                                    <div class="row justify-content-between align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <div class="text-lg-end my-1 my-lg-0">
                                                <a href="<?php echo base_url('Setting/Slider') ?>"><i class="fa fa-chevron-circle-left"></i> Kembali</a></button>
                                            </div>
                                        </div><!-- end col-->
                                    </div> <!-- end row -->
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    echo form_open_multipart('Setting/Update_Slider/'.$setting->kode);?>
                                        ...
                                        <div class="col-lg-12 text-center mt-4 mb-4">
                                            ...
                                            <?php } else { ?>
                                                <img src="<?= base_url('assets/image/slider/'.$setting->konten)?>" id="gambar_load" width="500px" height="300px">
                                            <?php } ?>
                                        </div>
