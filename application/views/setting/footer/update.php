                    ...
                    <div class="main-content" id="panel">
                        <div class="container-fluid mt-3">
                            ...
                            <div class="card">
                                        ...
                                        <div class="row justify-content-between align-items-center">
                                            ...
                                            <div class="col-auto">
                                                <div class="text-lg-end my-1 my-lg-0">
                                                    <a href="<?php echo base_url('Setting/Footer') ?>"><i class="fa fa-chevron-circle-left"></i> Kembali</a></button>
                                                </div>
                                            </div><!-- end col-->
                                        </div> <!-- end row -->
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <?php 
                                        echo form_open_multipart('Setting/Update_Footer/'.$setting->kode);?>
