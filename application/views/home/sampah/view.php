                                        ...
                                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                            <div class="row justify-content-between align-items-center">
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <a class="btn btn-primary rounded-pill waves-effect waves-light" href="<?= base_url('home/add_sampah') ?>">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="<?= base_url('home/update_sampah/'.$value->id) ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                                                        <a href="<?= base_url('home/delete_sampah/'.$value->id) ?>" onclick="return confirm('Yakin ingin hapus data ini?')">
