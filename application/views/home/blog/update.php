                ...
                <div class="container-fluid mt-5">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    echo form_open_multipart('home/update_data_eh');?>
                                        <input type="hidden" name="id" value="<?= $blog->id ?>">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="control-label">Nama<span style="color: red">*</span></label>
                                                    <input type="text" class="form-control<?php if(form_error('Nama')!=null){echo ' is-invalid';} ?>" value="<?= $blog->Nama ?>" name="Nama" maxlength="100" placeholder="Nama..">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control<?php if(form_error('Nama_Shop')!=null){echo ' is-invalid';} ?>" value="<?= $blog->Nama_Shop ?>" name="Nama_Shop" maxlength="100" placeholder="Nama Shop..">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control<?php if(form_error('Area')!=null){echo ' is-invalid';} ?>" value="<?= $blog->Area ?>" name="Area" maxlength="100" placeholder="Area..">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control<?php if(form_error('NPK')!=null){echo ' is-invalid';} ?>" value="<?= $blog->NPK ?>" name="NPK" placeholder="No NPK..">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" id="time-before" class="form-control<?php if(form_error('timeb')!=null){echo ' is-invalid';} ?>" value="<?= $blog->time_before ?>" rows="7" name="timeb" id="timeb" placeholder="Ketik disini untuk buat Blog!"></input>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" id="time-after" class="form-control<?php if(form_error('timea')!=null){echo ' is-invalid';} ?>" value="<?= $blog->time_after ?>" rows="7" name="timea" id="timea" placeholder="Ketik disini untuk buat Blog!"></input>
                                        ...
                                        <div class="row mt-3">                                                
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="gambar_after" class="form-control" id="preview_gambar-2" value="<?= $blog->gambar_after ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="konsumsi_before" class="form-control<?php if(form_error('energi_before')!=null){echo ' is-invalid';} ?>" value="<?= $blog->energi_before ?>" name="energi_before" maxlength="100" placeholder="konsumsi energi before EH..">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="konsumsi_after" class="form-control<?php if(form_error('energi_after')!=null){echo ' is-invalid';} ?>" value="<?= $blog->energi_after ?>" name="energi_after" placeholder="konsumsi energi after EH..">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="total_tco" class="form-control<?php if(form_error('total_tco')!=null){echo ' is-invalid';} ?>" value="<?= $blog->total_tco ?>" name="total_tco" maxlength="100" placeholder="Total Tco₂/Tahun.." readonly>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="total_reduce_tco" class="form-control<?php if(form_error('total_reduce_tco')!=null){echo ' is-invalid';} ?>" value="<?= $blog->total_reduce_tco ?>" name="total_reduce_tco" placeholder="Total Reduce Tco₂/Tahun.." readonly>
                ...
                $(document).ready(() => {
                    ...
                    $('#konsumsi_before, #time-before, #time-after').on('change', () => {
                        ...
                        if(konsumsi_before.val() != ""){
                            ...
                            const diffInMs = Math.abs(dateBefore - dateAfter);
                            
                            console.log(diffInMs)

                            calc = getTotalTco2(diffInMs, konsumsi_before.val());
                            total_tco.val(calc);
                        }
                    ...
                    $('#konsumsi_after, #time-before, #time-after').on('change', () => {
                        ...
                        if(konsumsi_after.val() != ""){
                            ...
                            calc = getTotalTco2(diffInMs, konsumsi_after.val());
