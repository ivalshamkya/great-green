                        ...
                        <div class="container-fluid mt-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    echo form_open_multipart('master_blog/add');?>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="isi" class="control-label">Time  Start<span style="color: red">*</span></label>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="isi" class="control-label">Time  Finish<span style="color: red">*</span></label>
