                    ...
                    <div class="main-content" id="panel">
                        <div class="container-fluid mt-3">
                            ...
                            <div class="card">
                                    ...
                                    <div class="card-body">
                                        <?php                                         
                                        echo form_open_multipart('Master_Departemen/update/'.$departemen->Id_Departemen);?>

                                            <div class="form-group">
                                                <label class="control-label">Nama Departemen<span style="color: red">*</span></label>
                                                <input type="text" class="form-control<?php if(form_error('Nama_Departemen')!=null){echo ' is-invalid';} ?>"name="Nama_Departemen" maxlength="100" placeholder="Nama Departemen.." value="<?= $departemen->Nama_Departemen ?>">
