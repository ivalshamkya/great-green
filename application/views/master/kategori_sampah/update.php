                    ...
                    <div class="main-content" id="panel">
                        <div class="container-fluid mt-3">
                            ...
                            <div class="card">
                                    ...
                                    <div class="card-body">
                                        <?php 
                                        echo form_open_multipart('master_kategori_sampah/update/'.$kategori_sampah->id);?>

                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label class="control-label">Nama<span style="color: red">*</span></label>
                                                        <input type="text" class="form-control<?php if(form_error('nama')!=null){echo ' is-invalid';} ?>" name="nama" placeholder="Nama.." value="<?= $kategori_sampah->nama ?>">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control<?php if(form_error('harga')!=null){echo ' is-invalid';} ?>" name="harga" placeholder="Harga.." value="<?= $kategori_sampah->harga ?>">
                                            ...
                                            <div class="form-group mt-3">
                                                ...
                                                <textarea rows="3" class="form-control<?php if(form_error('deskripsi')!=null){echo ' is-invalid';} ?>" name="deskripsi"><?= $kategori_sampah->deskripsi ?></textarea>
