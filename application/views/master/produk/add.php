                        ...
                        <div class="container-fluid mt-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    echo form_open_multipart('master_produk/add');?>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control<?php if(form_error('stok')!=null){echo ' is-invalid';} ?>" value="<?= set_value('stok') ?>" name="stok" placeholder="Stok..">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control<?php if(form_error('berat')!=null){echo ' is-invalid';} ?>" value="<?= set_value('berat') ?>" name="berat" placeholder="Berat..">
