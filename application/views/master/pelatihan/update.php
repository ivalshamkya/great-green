                        ...
                        <div class="container-fluid mt-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    echo form_open_multipart('master_pelatihan/update/'.$pelatihan->id);?>

                                        <div class="form-group">
                                            <label class="control-label">Nama Pelatihan<span style="color: red">*</span></label>
                                            <input type="text" class="form-control<?php if(form_error('nama')!=null){echo ' is-invalid';} ?>" name="nama" maxlength="100" placeholder="Nama.." value="<?= $pelatihan->nama ?>">
                                            <small class="form-text text-danger"><?= form_error('nama') ?></small>
                                        </div>

                                        <div class="form-group mt-3">
                                            <label class="control-label">Tema<span style="color: red">*</span></label>
                                            <input type="text" class="form-control<?php if(form_error('tema')!=null){echo ' is-invalid';} ?>" name="tema" maxlength="150" placeholder="Tema.." value="<?= $pelatihan->tema ?>">
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <textarea rows="3" class="form-control<?php if(form_error('deskripsi')!=null){echo ' is-invalid';} ?>" name="deskripsi"><?= $pelatihan->deskripsi ?></textarea>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control<?php if(form_error('mentor')!=null){echo ' is-invalid';} ?>" name="mentor" maxlength="200" placeholder="Mentor.." value="<?= $pelatihan->mentor ?>">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control<?php if(form_error('tempat')!=null){echo ' is-invalid';} ?>" name="tempat" maxlength="100" placeholder="Tempat.." value="<?= $pelatihan->tempat ?>">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control<?php if(form_error('tanggal')!=null){echo ' is-invalid';} ?>" type="date" name="tanggal" value="<?= $pelatihan->tanggal ?>">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group clockpicker<?php if(form_error('jam')!=null){echo ' is-invalid';} ?>" data-placement="top" data-align="top" data-autoclose="true">
                                                        <input type="text" class="form-control" name="jam" maxlength="20" placeholder="Jam.." value="<?= $pelatihan->jam ?>">
                                                    </div>
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <input type="file" name="gambar" class="form-control mb-3" id="preview_gambar">
                                        </div>

                                        <div class="col-lg-12 text-center mt-4 mb-4">
                                            <?php if ($pelatihan->gambar == null){ ?>
                                                <img src="<?= base_url('assets/image/master/all/Camera_Green.svg')?>" id="gambar_load" width="300px" height="300px">
                                            <?php } else { ?>
                                                <img src="<?= base_url('assets/image/master/pelatihan/'.$pelatihan->gambar)?>" id="gambar_load" width="300px" height="300px">
                                            <?php } ?>
                                        </div>
