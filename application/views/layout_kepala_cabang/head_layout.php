                    ...
                    <ul class="list-unstyled topnav-menu float-end mb-0">
                        <li class="dropdown notification-list topbar-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                                ...
                                <!-- profil -->
                                <a href="<?= base_url('master_user/profil_kc/'.$this->session->userdata('id')); ?>" class="dropdown-item notify-item">
                                    <i class="fe-user"></i>
                                    <span>Profil</span>
                                </a>
                ...
                <div class="h-100" data-simplebar>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul id="side-menu">
                            ...
                            <li class="menu-title">Menu Kepala Cabang</li>

                            <li>
                                <a href="<?php echo base_url('Dashboard_Kepala_Cabang') ?>">
                            ...
                            <li>
                                <a href="<?php echo base_url('Trans_Pemasukan_Sampah') ?>">
